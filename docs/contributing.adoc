...
Developers working *on* `Marid`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Marid.git
cd Marid
...
* Bugs in `Marid`: file at `hyperpolymath/Marid/issues`.
