...
| `README.adoc`
| `README.adoc` badge block (OpenSSF line removed at mint — no ID registered)
| placeholder
...
| `standards/3-practice/session-management-standards/`
| exists
...
* External to this repo: `standards/3-practice/session-management-standards/*`
...
* Protocols central: maintained in `standards/3-practice/session-management-standards/`.
