...
<!-- ARRIVAL-PACK:BEGIN — estate-common @Manifesto:DRAFT-unratified · repo @a2ml:CLADE@c7b2a442b70f ECOSYSTEM@f0c97a39747d AGENTIC@6abc2719f63a STATE@d5f2e383a9c2 ANCHOR@d8190633f96c — generated by `just claude-md`, do not hand-edit -->
...
- **IS** — Julia-first framework for web applications, APIs, and reactive scientific dashboards: six Julia packages (Marid core + five protocol integrations) and a framework-independent browser client, proved by one reference application.
- **IS-NOT** — a database engine (ArangoDB is the database; MaridArango.jl is a client) · a replacement universal IDL (native schemas stay native; contracts/ only records them) · a frontend framework (React/Vue are supported through standard APIs, never replaced) · a Genie clone built in one task (package-first program with gated acceptance tests)
...
- **State** — phase design; maturity experimental; 5% complete; status active.

<!-- ARRIVAL-PACK:END · provenance: CLADE@c7b2a442b70f ECOSYSTEM@f0c97a39747d AGENTIC@6abc2719f63a STATE@d5f2e383a9c2 ANCHOR@d8190633f96c · Manifesto@DRAFT-unratified · regenerate: `just claude-md` (k9 drift-detects; do not hand-edit above) -->
