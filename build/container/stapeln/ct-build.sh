...
#
# Marid — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: marid-release)
...
CT_KEY_ID="${CT_KEY_ID:-marid-release}"
...
echo "=== Marid Cerro Torre Build Pipeline ==="
